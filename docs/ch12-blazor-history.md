...
- [History of Blazor](#history-of-blazor)
- [JavaScript and friends](#javascript-and-friends)
- [Silverlight – C# and .NET using a plugin](#silverlight--c-and-net-using-a-plugin)
- [WebAssembly – a target for Blazor](#webassembly--a-target-for-blazor)
- [Blazor hosting models in .NET 7 and earlier](#blazor-hosting-models-in-net-7-and-earlier)
- [Unification of Blazor hosting models in .NET 8 and later](#unification-of-blazor-hosting-models-in-net-8-and-later)
- [Understanding Blazor components](#understanding-blazor-components)
- [What is the difference between Blazor and Razor?](#what-is-the-difference-between-blazor-and-razor)
